(ns aopmetrics.core
  (:require [aopmetrics.metrics :as metrics]
...
;After loading the file in REPL, disable the comment block so that you can run the metrics respectively. --line:13 to 230
(comment 
